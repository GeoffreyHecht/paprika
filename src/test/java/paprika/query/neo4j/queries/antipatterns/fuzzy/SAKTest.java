...
public class SAKTest extends AnalyzedApkTest {

    private String[] expectedInClasses = {
            getWitnessClass("sak.MySwissArmyKnife"),
    };
    ...
    private String[] absentInClasses = {
            ...
            getWitnessClass("interfaces.Interface1"),
            getWitnessClass("interfaces.Interface5")
    };

    @Test
    public void checkSAKResults() throws Exception {
        ...
        List<Map<String, Object>> results = filterResult(
                engine.execute(new SwissArmyKnife(reader).getFuzzyQuery(true)), DEFAULT_VERSION);
