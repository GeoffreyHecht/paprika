...
public class CCTest extends AnalyzedApkTest {

    private String[] expectedInClasses = {
            getWitnessClass("CC"),
            getWitnessClass("MyBlobClass"),
            getWitnessClass("ComplexClass"),
            getWitnessClass("heavy.HeavyASyncTask")
    };
    ...
    @Test
    public void checkCCResults() throws Exception {
        ...
        List<Map<String, Object>> results = filterResult(
                engine.execute(new ComplexClass(reader).getQuery(true)), DEFAULT_VERSION);
