...
public class IWRTest extends AnalyzedApkTest {
    ...
    public void checkIWRResults() {
        List<Map<String, Object>> unfiltered = engine.execute(new InvalidateWithoutRect().getQuery(true));
        List<Map<String, Object>> version14 = filterResult(unfiltered, 13);
        checkMethodEntries(version14, expectedInMethods, absentInMethods);
        List<Map<String, Object>> outdatedAfter = filterResult(unfiltered, DEFAULT_VERSION);
