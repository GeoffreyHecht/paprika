...
import static paprika.launcher.ArgumentMode.*;
...
public enum Argument {
    ...
    DEL_KEY_ARG("delKey", QUERY_MODE) {
        @Override
        public void setup(Subparser subparser) {
            subparser.addArgument("-dk", prefixArg(toString())).help("key to delete");
        }
    },

    DEL_PACKAGE_ARG("delPackage", QUERY_MODE) {
        @Override
        public void setup(Subparser subparser) {
            subparser.addArgument("-dp", prefixArg(toString())).help("Package of the applications to delete");
        }
    },
    ...
    public static final Argument[] PROPS_ARGS = {
    ...
    private String name;
    private ArgumentMode category;

    Argument(String name, ArgumentMode category) {
        this.name = name;
        this.category = category;
    }

    public static List<Argument> getAllArguments(ArgumentMode category) {
