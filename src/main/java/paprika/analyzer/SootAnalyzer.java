...
public class SootAnalyzer extends Analyzer {
    ...
    int argb8888Count = 0, activityCount = 0, innerCount = 0, varCount = 0,
            asyncCount = 0, serviceCount = 0, viewCount = 0, interfaceCount = 0,
            abstractCount = 0, broadcastReceiverCount = 0, contentProviderCount = 0;
    ...
    public void collectMethodsMetrics(SootMethod sootMethod) {
        ...
        if (sootMethod.hasActiveBody()) {
            ...
            int nbOfLines = activeBody.getUnits().size() - sootMethod.getParameterCount();
